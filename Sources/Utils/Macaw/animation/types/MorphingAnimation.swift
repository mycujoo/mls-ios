...
typealias MorphingAnimationDescription = AnimationDescription<Locus>

extension AnimatableVariable where T: LocusInterpolation {
...
extension AnimatableVariable where T: ContentsInterpolation {

...
public class DataProvider {
    ...
    public func eventList(pageSize: Int? = nil, pageToken: String? = nil, status: [ParamEventStatus]? = nil, orderBy: ParamEventOrder? = nil, completionHandler: @escaping ([Event]?) -> ()) {
        listEventsUseCase.execute(pageSize: pageSize, pageToken: pageToken, status: status, orderBy: orderBy) { (events, _) in

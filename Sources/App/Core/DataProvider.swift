...
public class DataProvider {
    ...
    /// - parameter completionHandler: gets called when the API response is available. Upon success, contains the Events, a nextPageToken and previousPageToken (respectively), to allow for pagination. Upon failure, this completionHandler is called with all-nil values.

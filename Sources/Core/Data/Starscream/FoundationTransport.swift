...
class FoundationTransport: NSObject, Transport, StreamDelegate {
    ...
    private func getSecurityData() -> (SecTrust?, String?) {
        ...
        let trust = outputStream.property(forKey: kCFStreamPropertySSLPeerTrust as Foundation.Stream.PropertyKey) as! SecTrust?
        var domain = outputStream.property(forKey: kCFStreamSSLPeerName as Foundation.Stream.PropertyKey) as! String?

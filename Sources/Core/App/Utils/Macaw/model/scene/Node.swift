...
class Node: Drawable {
    ...
    @discardableResult func onTouchPressed (_ f: @escaping (TouchEvent) -> Void) -> Disposable {
    ...
    @discardableResult func onTouchMoved(_ f: @escaping (TouchEvent) -> Void) -> Disposable {
        let handler = ChangeHandler<TouchEvent>(f)
    ...
    @discardableResult func onTouchReleased(_ f: @escaping (TouchEvent) -> Void) -> Disposable {
        let handler = ChangeHandler<TouchEvent>(f)
    ...
    @discardableResult func onTap(tapCount: Int = 1, f: @escaping (TapEvent) -> Void) -> Disposable {
    ...
    @discardableResult func onLongTap(_ f: @escaping (TapEvent) -> Void) -> Disposable {
        let handler = ChangeHandler<TapEvent>(f)
    ...
    @discardableResult func onPan(_ f: @escaping (PanEvent) -> Void) -> Disposable {
    ...
    @discardableResult func onRotate(_ f: @escaping (RotateEvent) -> Void) -> Disposable {
    ...
    @discardableResult func onPinch(_ f: @escaping (PinchEvent) -> Void) -> Disposable {
    ...
    init(place: Transform = Transform.identity, opaque: Bool = true, opacity: Double = 1, clip: Locus? = nil, mask: Node? = nil, effect: Effect? = nil, visible: Bool = true, tag: [String] = []) {

...
class MView: UIView, Touchable {
    ...
    override func touchesEnded(_ touches: Set<MTouch>, with event: MEvent?) {
        super.touchesEnded(touches, with: event)
        mTouchesEnded(touches, with: event)
    }

    override func touchesCancelled(_ touches: Set<MTouch>, with event: MEvent?) {

...
class MacawView: MView, MGestureRecognizerDelegate {
    ...
    override var contentMode: MViewContentMode {
    ...
    @objc init?(node: Node, coder aDecoder: NSCoder) {
    ...
    convenience init(node: Node, frame: CGRect) {
    ...
    func gestureRecognizer(_ gestureRecognizer: MGestureRecognizer, shouldReceive touch: MTouch) -> Bool {
        return true
    }

    func gestureRecognizer(_ gestureRecognizer: MGestureRecognizer, shouldRecognizeSimultaneouslyWith otherGestureRecognizer: MGestureRecognizer) -> Bool {
        return true
    }
}
...
internal class DrawingView: MView {
    ...
    var contentLayout: ContentLayout = .none {
        didSet {
...
class LayoutHelper {
    ...
    func getTransform(_ nodeRenderer: NodeRenderer, _ layout: ContentLayout, _ size: Size) -> Transform {
        setSize(size: size)
    ...
    class func calcTransform(_ node: Node, _ layout: ContentLayout, _ size: Size) -> Transform {

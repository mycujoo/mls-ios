...
class SVGParser {
    ...
    class func parse(bundle: Bundle, path: String, ofType: String = "svg") throws -> Node {
    ...
    /// - Throws: An SVGParserError of no such file
    @available(*, deprecated)
    class func parse(path: String, ofType: String = "svg") throws -> Node {
    ...
    /// - Returns: Root node of the corresponding Macaw scene.
    /// - Throws: An SVGParserError of no such file
    class func parse(resource: String,
    ...
    /// - Returns: Root node of the corresponding Macaw scene.
    /// - Throws: An SVGParserError of no such file
    class func parse(fullPath: String) throws -> Node {
    ...
    /// - returns: Root node of the corresponding Macaw scene.
    class func parse(text: String) throws -> Node {

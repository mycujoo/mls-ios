class SVGConstants {
    ...
    static func valueToColor(_ color: Int) -> String? {
        return SVGConstants.colorList.filter { _, v -> Bool in v == color }.map { k, _ -> String in k }.first
    }

    static let defaultStrokeLineCap = LineCap.butt
    static let defaultStrokeLineJoin = LineJoin.miter

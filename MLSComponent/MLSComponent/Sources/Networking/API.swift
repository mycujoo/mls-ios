    ...
    public var sampleData: Data {
        ...
        case .annotations(let timelineId):
            ...
            case "brusquevsmanaus":
                return Data("""
                    {"annotations":[{"id":"ann_1","offset":3000,"timeline_id":"tml_1","actions":[{"id":"f4354364q6afd","type":"show_timeline_marker","data":{"color":"#ffffff","label":"Kickoff"}},{"id":"54afag35yag","type":"show_overlay","data":{"custom_id":"scoreboard1","svg_url":"https://storage.googleapis.com/mycujoo-player-app.appspot.com/scoreboard_and_timer.svg","position":{"top":5.0,"leading":5.0},"size":{"width":20.0},"animatein_type":"fade_in","animatein_duration":0.3,"variable_positions":{"###_HOMESCORE_###":"homeScore","###_AWAYSCORE_###":"awayScore","###_TIMER_###":"timer1"}}}]},{"id":"ann_2","offset":2000,"timeline_id":"tml_1","actions":[{"id":"fda43t943f9a","type":"show_timeline_marker","data":{"color":"#ffff01","label":"Goal"}},{"id":"gagj9j9agj9a","type":"show_overlay","data":{"svg_url":"https://storage.googleapis.com/mycujoo-player-app.appspot.com/announcement_overlay.svg","position":{"bottom":0.0,"leading":0.0},"size":{"width":30.0},"animatein_type":"slide_from_trailing","animateout_type":"slide_to_trailing","animatein_duration":1.3,"animateout_duration":0.3,"duration":5.0,}}]},{"id":"ann_3","offset":7548000,"timeline_id":"tml_1","actions":[{"id":"bmb9t49bm34t","type":"show_timeline_marker","data":{"color":"#000000","label":"Fulltime"}},{"id":"f43f9ajf9dfjSX","type":"hide_overlay","data":{"custom_id":"scoreboard1","animateout_type":"fade_out","animateout_duration":0.3}}]}]}
                    """.utf8)
            default:
                return Data("""

    ...
    var sampleData: Data {
        ...
        case .annotations(let timelineId):
            ...
            case "brusquevsmanaus":
                return Data("""
                    {"annotations":[{"actions":[{"data":{"color":"#ffffff","label":"Kickoff"},"id":"f4354364q6afd","type":"show_timeline_marker"},{"data":{"animatein_duration":300,"animatein_type":"fade_in","custom_id":"scoreboard1","position":{"leading":5.0,"top":5.0},"size":{"width":25.0},"svg_url":"https://storage.googleapis.com/mycujoo-player-app.appspot.com/scoreboard_and_timer.svg","variable_positions":{"###_AWAYSCORE_###":"awayScore","###_HOMESCORE_###":"homeScore","###_TIMER_###":"timer1"}},"id":"54afag35yag","type":"show_overlay"}],"id":"ann_1","offset":1699000,"timeline_id":"tml_1"},{"actions":[{"data":{"color":"#ffff01","label":"Goal"},"id":"fda43t943f9a","type":"show_timeline_marker"},{"data":{"animatein_duration":500,"animatein_type":"slide_from_leading","animateout_duration":500,"animateout_type":"slide_to_leading","duration":5000,"position":{"bottom":10.0,"leading":5.0},"size":{"width":30.0},"svg_url":"https://storage.googleapis.com/mycujoo-player-app.appspot.com/announcement_overlay.svg"},"id":"gagj9j9agj9a","type":"show_overlay"}],"id":"ann_2","offset":5891000,"timeline_id":"tml_1"},{"actions":[{"data":{"color":"#de4f1f","label":"Fulltime"},"id":"bmb9t49bm34t","type":"show_timeline_marker"},{"data":{"animateout_duration":300,"animateout_type":"fade_out","custom_id":"scoreboard1"},"id":"f43f9ajf9dfjSX","type":"hide_overlay"}],"id":"ann_3","offset":8850000,"timeline_id":"tml_1"}]}
                    """.utf8)
            default:
                return Data("""

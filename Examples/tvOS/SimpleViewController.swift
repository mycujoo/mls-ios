...
import UIKit
import MLSSDK
import MLSSDK_IMA_tvOS


class SimpleViewController: UIViewController {
    private lazy var mls = MLS(publicKey: "", configuration: Configuration(seekTolerance: .zero, playerConfig: PlayerConfig(autoplay: false, imaAdUnit: "/124319096/external/single_ad_samples")))

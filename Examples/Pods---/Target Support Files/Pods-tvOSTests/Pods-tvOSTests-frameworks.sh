...
if [[ "$CONFIGURATION" == "Debug" ]]; then
  ...
  install_framework "${BUILT_PRODUCTS_DIR}/YouboraAVPlayerAdapter-tvOS/YouboraAVPlayerAdapter.framework"
  install_framework "${BUILT_PRODUCTS_DIR}/YouboraLib-tvOS/YouboraLib.framework"
  install_framework "${BUILT_PRODUCTS_DIR}/Cuckoo-tvOS/Cuckoo.framework"

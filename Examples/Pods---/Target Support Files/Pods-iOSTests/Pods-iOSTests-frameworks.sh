...
if [[ "$CONFIGURATION" == "Debug" ]]; then
  ...
  install_framework "${BUILT_PRODUCTS_DIR}/YouboraAVPlayerAdapter-iOS/YouboraAVPlayerAdapter.framework"
  install_framework "${BUILT_PRODUCTS_DIR}/YouboraLib-iOS/YouboraLib.framework"
  install_framework "${BUILT_PRODUCTS_DIR}/Cuckoo-iOS/Cuckoo.framework"
